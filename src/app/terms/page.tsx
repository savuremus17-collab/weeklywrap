      ...
      <div className="container mx-auto px-4 md:px-6 py-24 max-w-3xl">
        ...
        <div className="prose prose-invert max-w-none space-y-10 text-muted-foreground leading-relaxed">
          ...
          <section>
            ...
            <p className="mt-3">
              The Founding Member lifetime deal is a one-time payment that grants lifetime access to the Pro plan 
              as it exists at the time of purchase, including future updates to that plan tier.
            </p>
          </section>
          ...
          <section>
            ...
            <p>
              ...
              and we will issue a full refund. Refunds are not available after the 7-day period or for the 
              Founding Member lifetime deal after the product has been accessed.
            </p>
          </section>
