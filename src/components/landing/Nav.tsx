  ...
  return (
    <>
      ...
      <a
        ...
        className="block w-full bg-primary text-primary-foreground text-center text-sm font-medium py-2 px-4 hover:bg-primary/90 transition-colors z-50 relative"
      >
        <span className="flex items-center justify-center gap-2">
          <Zap size={14} />
          <span>
            <strong>Founding Member Deal</strong> — Lifetime access for $79 (was $499).
            Only <strong>12 spots</strong> left."use client";
import { useState, useEffect } from "react";
import Link from "next/link";
import { Zap } from "lucide-react";
